...
def insert_uploaded_item(item_description: str, image_link: str, user_id: str):
    res = insert_item(item_description, image_link, "User", user_id=user_id)

def insert_scraped_item(item_description: str, image_link: str, outfit_links: List[str], product_link: str):
    insert_item(item_description, image_link, "Scraped", outfit_links=outfit_links, product_link=product_link)
